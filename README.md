...
如果你想在阅读英文论文、资料或截图时快速获得高质量中文释义，AcadMaster 就是为此而生。
...
2. 点击“加载已解压的扩展程序（Load unpacked）”，选择本仓库根目录 `acadmaster`
...
如果你觉得 AcadMaster 对你的学习或研究有帮助，欢迎通过以下方式支持我们（可选）：

- 支付宝：扫描下方二维码进行一次性赞助或打赏
- 微信：扫描下方微信二维码进行赞助或关注

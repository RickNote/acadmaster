...
如果你觉得 XiaoEt 对你的学习或研究有帮助，欢迎通过以下方式支持我们（可选）：

- 支付宝：扫描下方二维码进行一次性赞助或打赏（请替换为你的真实二维码图片）
- 微信：扫描下方微信二维码进行赞助或关注

<div>
  <img src="assets/sponsor/alipay.svg" alt="支付宝赞助二维码" width="160" style="margin-right:16px;" />
  <img src="assets/sponsor/wechat.svg" alt="微信赞助二维码" width="160" />
</div>

小提示：在发布真实二维码前请确保图片文件不包含敏感信息；若仅想收款但不希望在仓库明文存储二维码图片，可以把二维码上传到图床并在 README 中引用外部链接，或仅在 `options.html` / 设置页面中显示二维码给最终用户。
